/*
  ...
  Descrição: Componente que representa a página inicial pública (landing page) do MindFlow. Apresenta a proposta de valor da ferramenta e direciona os usuários para o login ou cadastro.
*/
